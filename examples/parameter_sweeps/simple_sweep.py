...
task.common_assets.add_assets(AssetCollection.from_id_file("../singularity/definitions/python_minimal.sif.id"))  # Upload sif id 3eec2bb7-250c-f111-9318-f0921c167864 from comps2
